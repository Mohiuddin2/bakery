...
import { slugify, type ProductWithMeta } from "@/lib/products";
import type { Product } from "@/lib/data";

interface ProductCardProps {
  product: Product | ProductWithMeta;
    ...
    >
      <Link href={href} className="flex flex-1 flex-col">
        ...
        >
          ...
          <span
            aria-hidden
            className="absolute right-4 top-4 grid h-9 w-9 place-items-center rounded-full bg-cream/85 text-brown backdrop-blur transition-all duration-300 group-hover:bg-yellow group-hover:text-ink"
          >
